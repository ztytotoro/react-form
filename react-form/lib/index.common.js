...
})(exports.FormItemKind || (exports.FormItemKind = {}));
...
var FormGroup = /** @class */ (function (_super) {
    ...
    function FormGroup(name, definition, _group) {
        ...
        Object.entries(definition.controls).forEach(function (_a) {
            ...
            if (control.kind === exports.FormItemKind.Control) {
                _this._controlMap.set(name, new FormControl(name, control, _this));
            }
            else if (control.kind === exports.FormItemKind.Group) {
    ...
    FormGroup.prototype.get = function (path) {
        ...
        if (path.length > 0) {
            ...
            if (((_a = item) === null || _a === void 0 ? void 0 : _a.kind) === exports.FormItemKind.Group) {
                return item.get(path);
            }
            if (((_b = item) === null || _b === void 0 ? void 0 : _b.kind) === exports.FormItemKind.Control) {
...
function usePromise(promise) {
    ...
    var _b = React.useState(false), done = _b[0], setDone = _b[1];
...
var PromisedText = function (_a) {
    ...
    return text ? React__default.createElement(React__default.Fragment, null, text) : React__default.createElement(React__default.Fragment, null);
};
...
var RenderedControl = function (_a) {
    ...
    var _b = React.useState(control.disabled), disabled = _b[0], setDisabled = _b[1];
    var _c = React.useState(control.value), value = _c[0], setValue = _c[1];
    var _d = React.useState(control.isValid), isValid = _d[0], setIsValid = _d[1];
    var _e = React.useState([]), errorTips = _e[0], setErrorTips = _e[1];
    React.useEffect(function () {
    ...
    if (Control) {
        ...
        return (React__default.createElement("div", { className: "FormControl" },
            React__default.createElement("label", { className: "FormControlLabel" },
                React__default.createElement(PromisedText, { textPromise: control.definition.label })),
            React__default.createElement(Control, { value: value, onChange: onChange, params: control.definition.params, disabled: disabled }),
            !isValid ? (errorTips.map(function (tip, index) { return React__default.createElement("label", { key: index }, tip); })) : (React__default.createElement(React__default.Fragment, null))));
    }
...
function renderGroup(group) {
    return group.controlList.map(function (control, index) {
        ...
        var node;
        if (control.kind === exports.FormItemKind.Control) {
            node = (React__default.createElement(RenderedControl, { key: control.name, control: control }));
        }
        else if (control.kind === exports.FormItemKind.Group) {
            node = (React__default.createElement(RenderedGroup, { key: (_a = control.name, (_a !== null && _a !== void 0 ? _a : index)), group: control }));
        }
        else {
            node = React__default.createElement(React__default.Fragment, null);
        }
        return {
...
var RenderedGroup = function (_a) {
    var group = _a.group;
    var _b = React.useState(group.visible), visible = _b[0], setVisible = _b[1];
    React.useEffect(function () {
        group.onStateChange(function () { return setVisible(group.visible); });
    });
    var Group = getGroup(group.definition.type);
    if (Group) {
        return (React__default.createElement(Group, { controls: renderGroup(group), visible: visible, params: group.definition.params, label: group.definition.label }));
    }
...
function renderForm(formDef, container) {
    ...
    ReactDOM.render(React__default.createElement(RenderedGroup, { group: form }), container);
    return form;
}
